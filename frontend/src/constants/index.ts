...
export const NAVIGATION_ITEMS: NavigationItem[] = [
  {
    ...
    path: '/dashboard',
    icon: Home,
    roles: ['physician', 'nurse', 'admin', 'pharmacist', 'lab_tech', 'radiology_tech'],
  },
  {
    label: 'Patients',
    path: '/patients',
  ...
  },
  {
    ...
    path: '/results',
    icon: BarChart3,
    roles: ['physician', 'nurse', 'lab_tech', 'radiology_tech'],
    children: [
      {
        label: 'Lab Results',
        path: '/results/lab',
        icon: FlaskConical,
        roles: ['physician', 'nurse', 'lab_tech'],
      },
      {
        label: 'Imaging Results',
        path: '/results/imaging',
        icon: Zap,
        roles: ['physician', 'nurse', 'radiology_tech'],
      },
      {
        label: 'Trending',
  ...
  },
  {
    ...
    path: '/reports',
    icon: BarChart3,
    roles: ['physician', 'admin', 'system_admin'],
    children: [
      {
